...
(this), TL.debug = !1, TL.Bind = function (t, e) {
	...
	extend: function (t) {
		for (var e, i = Array.prototype.slice.call(arguments, 1), n = 0, a = i.length; n < a; n++)
			e = i[n] || {},
		TL.Util.mergeData(t, e);
		return t
	},
	isEven: function (t) {
	...
	convertUnixTime: function (t) {
		...
		return e = new Date(r[0], r[1], r[2], r[3], r[4], r[5]),
	...
	ensureUniqueKey: function (t, e) {
		if (e || (e = TL.Util.unique_ID(6)), !(e in t))
			return e;
		var i = e.match(/^(.+)(-\d+)?$/)[1],
		n = [];
		for (key in t)
		...
		e = i + "-" + (n.length + 1);
		for (var a = n.length; n.indexOf(e) != -1; a++)
			e = i + "-" + a;
		return e
	},
	htmlify: function (t) {
	...
	linkify: function (t, e, i) {
		var n = function (t, e, i) {
			i || (i = "");
			var n = 30;
			return e && e.length > n && (e = e.substring(0, n) + "…"),
	...
	template: function (t, e) {
		return t.replace(/\{ *([\w_]+) *\}/g, function (t, i) {
			...
			if (!e.hasOwnProperty(i))
				throw new TL.Error("template_value_err", t);
			return n
		})
	},
	hexToRgb: function (t) {
	...
	ratio: {
		square: function (t) {
			...
			return t.w > t.h && t.h > 0 ? (e.h = t.h, e.w = t.h) : (e.w = t.w, e.h = t.w),
			e
		},
		r16_9: function (t) {
	...
	getUrlVars: function (t) {
		...
		a = [];
		e = t.toString(),
		e.match("&#038;") ? e = e.replace("&#038;", "&") : e.match("&#38;") ? e = e.replace("&#38;", "&") : e.match("&amp;") && (e = e.replace("&amp;", "&")),
	...
	slugify: function (t) {
		t = TL.Util.trim(t),
		t = t.toLowerCase();
		for (var e = "ãàáäâẽèéëêìíïîõòóöôùúüûñç·/_,:;", i = "aaaaaeeeeeiiiiooooouuuunc------", n = 0, a = e.length; n < a; n++)
	...
	isEmptyObject: function (t) {
		...
		for (var n = 0; n < e.length; n++) {
			var a = e[n];
			if (null != t[a] && "string" != typeof t[a])
				return !1;
			if (0 != TL.Util.trim(t[a]).length)
				return !1
		}
		return !0
	},
		...
		return {
			...
			decode: function (t) {
				...
				for (var n = 0; t; ) {
					var a = e.indexOf(t[0]);
					if (a < 0)
						throw '"decode" can\'t find "' + t[0] + '" in the alphabet: "' + e + '"';
					var s = t.length - 1;
					n += a * Math.pow(i, s),
					t = t.substring(1)
				}
	...
	var e = function () {
		...
		function u(t) {
			var e,
			i;
			return C[t] || (e = S.createElement(t), S.body.appendChild(e), i = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == i && (i = "block"), C[t] = i),
			C[t]
		}
		function m(t) {
	...
	return G.matches = function (t, e) {
		...
		if (i)
			...
			a = t.parentNode,
			s = !a;
			return s && (a = V).appendChild(t),
			n = ~G.qsa(a, e).indexOf(t),
			s && V.removeChild(t),
			n
		},
		x = function (t) {
		...
		G.fragment = function (t, e, i) {
			...
			a,
			o;
			return U.test(t) && (n = $(S.createElement(RegExp.$1))),
			n || (t.replace && (t = t.replace(j, "<$1></$2>")), e === L && (e = A.test(t) && RegExp.$1), e in H || (e = "*"), o = H[e], o.innerHTML = "" + t, n = $.each(D.call(o.childNodes), function () {
						o.removeChild(this)
					})),
		...
		$.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function (t, e) {
		...
		$.fn = {
			...
			parents: function (t) {
				for (var e = [], i = this; i.length > 0; )
					i = $.map(i, function (t) {
							if ((t = t.parentNode) && !n(t) && e.indexOf(t) < 0)
								return e.push(t), t
						});
				return p(e, t)
			},
			...
			wrap: function (t) {
				var i = e(t);
				if (this[0] && !i)
					var n = $(t).get(0), a = n.parentNode || this.length > 1;
			...
			prop: function (t, e) {
				return t = J[t] || t,
				e === L ? this[0] && this[0][t] : this.each(function (i) {
			...
			position: function () {
				if (this.length) {
					...
					n = O.test(e[0].nodeName) ? {
					 ...
					 : e.offset();
					return i.top -= parseFloat($(t).css("margin-top")) || 0,
					i.left -= parseFloat($(t).css("margin-left")) || 0,
					n.top += parseFloat($(e[0]).css("border-top-width")) || 0,
					n.left += parseFloat($(e[0]).css("border-left-width")) || 0, {
						top: i.top - n.top,
						left: i.left - n.left
					}
				}
	...
	function ($) {
		...
		function o(e, n, o, r, h, c, u) {
			...
			n.split(/\s/).forEach(function (t) {
				...
				n.i = _.length,
				_.push(n),
				"addEventListener" in e && e.addEventListener(s(n.e), n.proxy, a(n, u))
			})
		}
		function r(i, n, o, r, l) {
			...
			(n || "").split(/\s/).forEach(function (t) {
				e(i, t, o, r).forEach(function (t) {
					delete p[h][t.i],
					"removeEventListener" in i && i.removeEventListener(s(t.e), t.proxy, a(t, l))
				})
			})
		}
		function l(t, e) {
			return !e && t.isDefaultPrevented || (e || (e = t), $.each(b, function (i, n) {
					...
					t[n] = L
				}), (e.defaultPrevented !== d ? e.defaultPrevented : "returnValue" in e ? e.returnValue === !1 : e.getPreventDefault && e.getPreventDefault()) && (t.isDefaultPrevented = T)),
			t
		}
		function h(t) {
			var e,
		...
		$.fn.live = function (t, e) {
			return $(document.body).delegate(this.selector, t, e),
			this
		},
		$.fn.die = function (t, e) {
			return $(document.body).undelegate(this.selector, t, e),
			this
		},
		...
		$.fn.trigger = function (t, e) {
			return t = _(t) || $.isPlainObject(t) ? $.Event(t) : l(t),
			t._args = e,
			this.each(function () {
		...
		$.fn.triggerHandler = function (t, i) {
			...
			return this.each(function (s, o) {
				...
				n._args = i,
				n.target = o,
				$.each(e(o, t.type || t), function (t, e) {
	...
	function ($) {
		...
		function s(t, i, n, a) {
			var s = n.context,
			o = "success";
			n.success.call(s, t, o, i),
			a && a.resolveWith(s, [t, o, i]),
			e(n, s, "ajaxSuccess", [i, n, t]),
			r(o, i, n)
		}
		function o(t, i, n, a, s) {
			var o = a.context;
			a.error.call(o, n, i, t),
			s && s.rejectWith(o, [n, i, t]),
			e(a, o, "ajaxError", [n, a, t || i]),
			r(i, n, a)
		}
		function r(t, i, a) {
			var s = a.context;
			a.complete.call(s, i, t),
			e(a, s, "ajaxComplete", [i, a]),
			n(a)
		}
		function l() {}
		function h(t) {
			return t && (t = t.split(";", 2)[0]),
			t && (t == w ? "html" : t == L ? "json" : y.test(t) ? "script" : T.test(t) && "xml") || "text"
		}
		function d(t, e) {
			return "" == e ? t : (t + "&" + e).replace(/[&?]{1,2}/, "?")
		}
		function c(t) {
			t.processData && t.data && "string" != $.type(t.data) && (t.data = $.param(t.data, t.traditional)),
		...
		function m(t, e, i, n) {
			...
			$.each(e, function (e, r) {
				a = $.type(r),
				n && (e = i ? n : n + "[" + (o || "object" == a || "array" == a ? e : "") + "]"),
				!n && s ? t.add(r.name, r.value) : "array" == a || !i && "object" == a ? m(t, r, i, e) : t.add(e, r)
			})
		}
		var _,
		p,
		...
		$.ajaxJSONP = function (t, e) {
			...
			return e && e.promise(u),
			$(h).on("load error", function (a, r) {
				clearTimeout(n),
				$(h).off().remove(),
				"error" != a.type && i ? s(i[0], u, t, e) : o(null, r || "error", u, t, e),
				window[l] = d,
				i && $.isFunction(d) && d(i[0]),
				d = i = void 0
			}),
		...
		$.ajax = function (t) {
			...
			c(e),
			e.cache === !1 && (e.url = d(e.url, "_=" + Date.now()));
			var r = e.dataType,
			u = /\?.+=\?/.test(e.url);
			if ("jsonp" == r || u)
				return u || (e.url = d(e.url, e.jsonp ? e.jsonp + "=?" : e.jsonp === !1 ? "" : "callback=?")),
				$.ajaxJSONP(e, n);
			var m,
			f = e.accepts[r],
			g = {},
			...
			if (T.setRequestHeader = v, T.onreadystatechange = function () {
				if (4 == T.readyState) {
					...
					if (T.status >= 200 && T.status < 300 || 304 == T.status || 0 == T.status && "file:" == y) {
						r = r || h(e.mimeType || T.getResponseHeader("content-type")),
						t = T.responseText;
						try {
		...
		$.fn.load = function (t, e, i) {
			...
			o = u(t, e, i),
			r = o.success;
			return s.length > 1 && (o.url = s[0], n = s[1]),
			o.success = function (t) {
				a.html(n ? $("<div>").html(t.replace(v, "")).find(n) : t),
...
(TL), TL.Class = function () {}, TL.Class.extend = function (t) {
	...
	removeEventListener: function (t, e, i) {
		...
		for (var n = 0, a = this._tl_events, s = a[t].length; n < s; n++)
			if (a[t][n].action === e && (!i || a[t][n].context === i))
				return a[t].splice(n, 1), this;
		return this
	},
	fireEvent: function (t, e) {
		...
		for (var i = TL.Util.mergeData({
					type: t,
					target: this
				}, e), n = this._tl_events[t].slice(), a = 0, s = n.length; a < s; a++)
...
(this.document), TL.LoadIt = function (t) {
	...
	function a(a, d, u, m, _) {
		...
		b = [];
		if (r || n(), d)
			if (d = "string" == typeof d ? [d] : d.concat(), w || r.async || r.gecko || r.opera)
				c[a].push({
					urls: d,
					callback: u,
					obj: m,
		...
		if (!h[a] && (v = h[a] = c[a].shift())) {
			for (l || (l = t.head || t.getElementsByTagName("head")[0]), y = v.urls, p = 0, f = y.length; p < f; ++p)
			 ...
			 : w && (r.gecko || r.webkit) ? r.webkit ? (v.urls[p] = g.href, o()) : (g.innerHTML = '@import "' + T + '";', s(g)) : g.onload = g.onerror = L,
			b.push(g);
			for (p = 0, f = b.length; p < f; ++p)
				l.appendChild(b[p])
		}
	}
	function s(t) {
		...
		try {
			...
			return d += 1,
			void(d < 200 ? setTimeout(function () {
					s(t)
				}, 50) : e && i("css"))
		}
		i("css")
...
(this.document), TL.TimelineConfig = TL.Class.extend({
		...
		validate: function () {
			...
			for (var t = 0; t < this.eras.length; t++)
				if ("undefined" == typeof this.eras[t].start_date || "undefined" == typeof this.eras[t].end_date) {
					var e;
					e = this.eras[t].text && this.eras[t].text.headline ? this.eras[t].text.headline : "era " + (t + 1),
		...
		addEvent: function (t, e) {
			...
			if ("undefined" == typeof t.start_date)
				throw new TL.Error("missing_start_date_err", i);
			return this._processDates(t),
			this._tidyFields(t),
			this.events.push(t),
			this.event_dict[i] = t,
		...
		_assignID: function (t) {
			var e = t.unique_id;
			return TL.Util.trim(e) || (e = t.text ? TL.Util.slugify(t.text.headline) : null),
			t.unique_id = TL.Util.ensureUniqueKey(this.event_dict, e),
			t.unique_id
		},
		_makeUniqueIdentifiers: function (t, e) {
			for (var i = [t], n = 0; n < e.length; n++)
				TL.Util.trim(e[n].unique_id) && (e[n].unique_id = TL.Util.slugify(e[n].unique_id), i.indexOf(e[n].unique_id) == -1 ? i.push(e[n].unique_id) : e[n].unique_id = "");
		...
		getLatestDate: function () {
			...
			return TL.DateUtil.sortByDate(t, "date"),
			t.slice(-1)[0].date
		},
	...
	function e(t) {
		...
		if (t.match(e))
			...
			t.match(/^\b[-_A-Za-z0-9]+$/) && (parts.key = t);
	...
	function i(e) {
		...
		return i.startdate && (n.start_date = t.Date.parseDate(i.startdate)),
		i.enddate && (n.end_date = t.Date.parseDate(i.enddate)),
		n
	}
	function n(e) {
		function i(t) {
	...
	var a = function (e) {
		if ("undefined" == typeof e.feed.entry || 0 == e.feed.entry.length)
			throw new t.Error("empty_feed_err");
	...
	o = function (i) {
		...
		return n = JSON.parse(n.responseText),
		r(n)
	},
	r = function (t) {
		for (var e = {
				...
				warnings: [],
				eras: []
			}, i = a(t), n = 0; n < t.feed.entry.length; n++)
			try {
				var s = i(t.feed.entry[n]);
				if (s) {
					var o = "event";
					"undefined" != typeof s.type && (o = s.type, delete s.type),
					"title" == o ? e.title ? (e.warnings.push("Multiple title slides detected."), e.events.push(s)) : e.title = s : "era" == o ? e.eras.push(s) : e.events.push(s)
				}
			} catch (t) {
	...
	l = function (i, n) {
		...
		if (s) {
			try {
				...
				return a = new t.TimelineConfig,
				"NetworkError" == e.name ? a.logError(new t.Error("network_err")) : "TL.Error" == e.name ? a.logError(e) : a.logError(new t.Error("unknown_read_err", e.name)),
				void n(a)
			}
			if (a = new t.TimelineConfig(r), r.errors)
				for (var l = 0; l < r.errors.length; l++)
					a.logError(r.errors[l]);
			n(a)
		} else
			t.ajax({
				url: i,
				...
				success: function (e) {
					try {
						...
						a = new t.TimelineConfig,
						a.logError(e)
					}
					n(a)
				},
				error: function (e, i, s) {
					if (a = new t.TimelineConfig, "parsererror" == i)
						var s = new t.Error("invalid_url_err");
					else
						var s = new t.Error("unknown_read_err", i);
					a.logError(s),
					n(a)
				}
			})
	...
	t.ConfigFactory = {
		...
		fromGoogle: function (t) {
			return console.warn("TL.ConfigFactory.fromGoogle is deprecated and will be removed soon. Use TL.ConfigFactory.makeConfig(url,callback)"),
			o(t)
		},
		makeConfig: l
	}
...
(TL), TL.Language = function (t) {
	...
	if (t && t.language && "string" == typeof t.language && "en" != t.language) {
		...
		if (!(e in TL.Language.languages)) {
			...
			if (200 != s.status)
				throw "Could not load language [" + e + "]: " + s.statusText;
	...
	if (n) {
		for (var a = 0; a < n.length; a++) {
			var s = n[a];
			if (Math.abs(i / s[0]) > 1)
				return TL.Language.formatNumber(Math.abs(i / s[0]), s[1])
		}
		return i.toString()
	}
	return trace("Language file dateformats missing cosmological. Falling back."),
	...
	n = "";
	return i.prefix && (n += "<span>" + i.prefix + "</span> "),
	n += t,
	...
	function a(t, e) {
		var i,
		n = {};
		return (i = t.match(E)) && (n.rotate = p(i[1], e ? e.rotate : null)),
		(i = t.match(S)) && (n.scale = p(i[1], e ? e.scale : null)),
		(i = t.match(C)) && (n.skewx = p(i[1], e ? e.skewx : null), n.skewy = p(i[3], e ? e.skewy : null)),
		(i = t.match(N)) && (n.translatex = p(i[1], e ? e.translatex : null), n.translatey = p(i[3], e ? e.translatey : null)),
		n
	}
	function s(t) {
		var e = "";
	...
	function m(t, e, i) {
		...
		r = [];
		for (n = 0; n < 6; n++)
			s = Math.min(15, parseInt(e.charAt(n), 16)), o = Math.min(15, parseInt(i.charAt(n), 16)), a = Math.floor((o - s) * t + s), a = a > 15 ? 15 : a < 0 ? 0 : a, r[n] = a.toString(16);
		return "#" + r.join("")
	}
	...
	function f(t, e) {
		...
		for (v && (n = e.left, o = e.top, delete e.right, delete e.bottom, delete e.left, delete e.top), i = d.length; i--; ) {
			if (y[i] = {}, T[i] = {}, L[i] = {}, v) {
				...
				w[i] = h(v) ? v(d[i], M) : v,
				w[i].push(M),
				w[i].unshift([parseInt(b, 10), parseInt(x, 10)])
			}
			for (var E in e) {
				switch (E) {
				case "complete":
...
(), TL.Point = function (t, e, i) {
	...
	setPosition: function (t, e) {
		t._tl_pos = e,
		TL.Browser.webkit3d ? (t.style[TL.Dom.TRANSFORM] = TL.Dom.getTranslateString(e), TL.Browser.android && (t.style["-webkit-perspective"] = "1000", t.style["-webkit-backface-visibility"] = "hidden")) : (t.style.left = e.x + "px", t.style.top = e.y + "px")
	},
	...
	getViewportOffset: function (t) {
		...
		a = document.body;
		do {
			if (e += n.offsetTop || 0, i += n.offsetLeft || 0, n.offsetParent === a && "absolute" === TL.DomUtil.getStyle(n, "position"))
				break;
			n = n.offsetParent
		} while (n);
		n = t;
	...
	disableTextSelection: function () {
		...
		this._onselectstart || (this._onselectstart = document.onselectstart, document.onselectstart = TL.Util.falseFn)
	},
	...
	setPosition: function (t, e) {
		t._tl_pos = e,
		TL.Browser.webkit3d ? (t.style[TL.DomUtil.TRANSFORM] = TL.DomUtil.getTranslateString(e), TL.Browser.android && (t.style["-webkit-perspective"] = "1000", t.style["-webkit-backface-visibility"] = "hidden")) : (t.style.left = e.x + "px", t.style.top = e.y + "px")
	},
	getPosition: function (t) {
		return t._tl_pos
	}
	...
	addListener: function (t, e, i, n) {
		...
		if (!t[s]) {
			...
			if (TL.Browser.touch && "dblclick" === e && this.addDoubleTapListener)
				this.addDoubleTapListener(t, o, a);
				...
				if ("mousewheel" === e)
					...
					o = function (e) {
						if (TL.DomEvent._checkMouse(t, e))
							return r(e)
					},
	...
	_getEvent: function () {
		var t = window.event;
		if (!t)
			for (var e = arguments.callee.caller; e && (t = e.arguments[0], !t || window.Event !== t.constructor); )
				e = e.caller;
		return t
	},
	...
	stop: function (t) {
		TL.DomEvent.preventDefault(t),
		TL.DomEvent.stopPropagation(t)
	},
	getWheelDelta: function (t) {
		...
		addRule: function (t, e, i) {
			var n = 0;
			i && (n = i),
			"insertRule" in this.sheet ? this.sheet.insertRule(t + "{" + e + "}", n) : "addRule" in this.sheet && this.sheet.addRule(t, e, n)
		},
		onLoaded: function (t) {
		...
		getDisplayDate: function (t, e) {
			...
			t.constructor != TL.Language && (trace("First argument to getDisplayDate must be TL.Language"), t = TL.Language.fallback);
		...
		floor: function (t) {
			for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < TL.Date.SCALES.length; i++)
				if (TL.Date.SCALES[i][2](e), TL.Date.SCALES[i][0] == t)
					return new TL.Date(e);
		...
		findBestFormat: function (t) {
			for (var e = TL.Date.DATE_PARTS, i = 0; i < e.length; i++)
				if (this.data[e[i]])
					return t ? t in TL.Date.BEST_DATEFORMATS || (t = "short") : t = "base", TL.Date.BEST_DATEFORMATS[t][e[i]];
			return ""
		},
	...
	return isNaN(e.getTime()) ? new TL.BigDate(t) : e
		...
		initialize: function (t) {
			if (this.year = parseInt(t), isNaN(this.year))
				throw new TL.Error("invalid_year_err", t)
		},
		isBefore: function (t) {
	...
	t.parseISODate = function (t) {
		var e = new Date(t);
		if (isNaN(e))
			throw new TL.Error("invalid_date_err", t);
		return {
			year: e.getFullYear(),
			month: e.getMonth() + 1,
			day: e.getDate(),
	...
	t.parseDate = function (n) {
		if (n.match(e)) {
			...
			return a[1] && (s.month = a[1].replace("-", "")),
			a[2] && (s.day = a[2].replace("-", "")),
			s
		}
		if (n.match(i))
			return t.parseISODate(n);
		if (n.match(/^\-?\d+$/))
			return {
				year: n
			};
		...
		if (n.match(":")) {
			...
			o.hour = h[0],
			o.minute = h[1],
			h[2] && (second_parts = h[2].split("."), o.second = second_parts[0], o.millisecond = second_parts[1])
		}
		return o
	},
	t.BEST_DATEFORMATS = {
...
(TL.BigDate), TL.DateUtil = {
	...
	parseTime: function (t) {
		...
		if (s ? a = s.slice(1) : (a = t.split(":"), 1 == a.length && (a = t.split("."))), a.length > 4)
			throw new TL.Error("invalid_separator_error");
		if (e.hour = parseInt(a[0]), i && "p" == i.toLowerCase()[0] && 12 != e.hour ? e.hour += 12 : i && "a" == i.toLowerCase()[0] && 12 == e.hour && (e.hour = 0), isNaN(e.hour) || e.hour < 0 || e.hour > 23)
			throw new TL.Error("invalid_hour_err", e.hour);
		if (a.length > 1 && (e.minute = parseInt(a[1]), isNaN(e.minute)))
			throw new TL.Error("invalid_minute_err", e.minute);
		if (a.length > 2) {
			var o = a[2].split(/[\.,]/);
			if (a = o.concat(a.slice(3)), a.length > 2)
				throw new TL.Error("invalid_second_fractional_err");
			if (e.second = parseInt(a[0]), isNaN(e.second))
	...
	SCALE_DATE_CLASSES: {
		...
		_onDragStart: function (t) {
			TL.Browser.touch ? t.originalEvent ? (this.data.pagex.start = t.originalEvent.touches[0].screenX, this.data.pagey.start = t.originalEvent.touches[0].screenY) : (this.data.pagex.start = t.targetTouches[0].screenX, this.data.pagey.start = t.targetTouches[0].screenY) : (this.data.pagex.start = t.pageX, this.data.pagey.start = t.pageY),
		...
		_onDragMove: function (t) {
			t.preventDefault(),
			this.data.sliding = !0,
			TL.Browser.touch ? t.originalEvent ? (this.data.pagex.end = t.originalEvent.touches[0].screenX, this.data.pagey.end = t.originalEvent.touches[0].screenY) : (this.data.pagex.end = t.targetTouches[0].screenX, this.data.pagey.end = t.targetTouches[0].screenY) : (this.data.pagex.end = t.pageX, this.data.pagey.end = t.pageY),
		...
		_animateMomentum: function () {
			...
			this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"),
			this.options.enable.x && ((this.options.constraint.left || this.options.constraint.right) && (t.x > this.options.constraint.left ? t.x = this.options.constraint.left : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)), e.left = Math.floor(t.x) + "px"),
		...
		_animateMomentum: function () {
			...
			this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"),
			this.options.enable.x && (this.options.constraint.left && t.x >= this.options.constraint.left && (t.x = this.options.constraint.left), this.options.constraint.right && t.x < this.options.constraint.right && (t.x = this.options.constraint.right), e.left = Math.floor(t.x) + "px"),
			this.animator = TL.Animate(this._el.move, e),
			this.fire("momentum", this.data)
		}
		...
		initialize: function (t, e, i) {
			...
			this.collapsed = !1,
			"object" == typeof t ? this._el.container = t : this._el.container = TL.Dom.get(t),
			e && (this._el.parent = e),
			this.options = {
				width: 600,
				height: 600,
	...
	return !1
		...
		initialize: function (t, e, i) {
			...
			TL.Util.mergeData(this.options, e),
			TL.Util.mergeData(this.data, t),
			this.options.background || (this._el.container = TL.Dom.create("div", "tl-media"), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._initLayout(), i && (i.appendChild(this._el.container), this._el.parent = i))
		},
		loadMedia: function () {
			var t = this;
		...
		showMeta: function (t, e) {
			...
			this.data.caption && "" != this.data.caption && (this._el.caption = TL.Dom.create("div", "tl-caption", this._el.content_container), this._el.caption.innerHTML = 1 == this.options.autolink ? TL.Util.linkify(this.data.caption) : this.data.caption, this.options.caption_height = this._el.caption.offsetHeight),
		...
		updateMeta: function () {
			!this.data.credit && this.data.credit_alternate && (this._el.credit = TL.Dom.create("div", "tl-credit", this._el.content_container), this._el.credit.innerHTML = this.data.credit_alternate, this.options.credit_height = this._el.credit.offsetHeight),
			!this.data.caption && this.data.caption_alternate && (this._el.caption = TL.Dom.create("div", "tl-caption", this._el.content_container), this._el.caption.innerHTML = this.data.caption_alternate, this.options.caption_height = this._el.caption.offsetHeight),
			this.updateDisplay()
		},
		onAdd: function () {
			this.fire("added", this.data)
		...
		createMedia: function () {
			...
			this.data.alt ? this._el.content_item.alt = this.data.alt : this.data.caption && (this._el.content_item.alt = TL.Util.unhtmlify(this.data.caption)),
			this.data.title ? this._el.content_item.title = this.data.title : this.data.caption && (this._el.content_item.title = TL.Util.unhtmlify(this.data.caption)),
		...
		_getMeta: function () {
			...
			TL.getJSON(t, function (t) {
				e.data.credit_alternate = "<a href='" + e.data.url + "' target='_blank'>" + t.photo.owner.realname + "</a>",
		...
		_loadMedia: function () {
			...
			if (this._el.content_item = TL.Dom.create("div", "tl-media-item tl-media-iframe", this._el.content), this.data.url.match("open?id="))
				this.media_id = this.data.url.split("open?id=")[1], this.data.url.match("&authuser=0") && (t = this.media_id.match("&authuser=0")[0]);
		...
		createMedia: function () {
			...
			this.data.link ? (this._el.content_link = TL.Dom.create("a", "", this._el.content), this._el.content_link.href = this.data.link, this._el.content_link.target = "_blank", this._el.content_item = TL.Dom.create("img", e, this._el.content_link)) : this._el.content_item = TL.Dom.create("img", e, this._el.content),
			this.data.alt ? this._el.content_item.alt = this.data.alt : this.data.caption && (this._el.content_item.alt = TL.Util.unhtmlify(this.data.caption)),
			this.data.title ? this._el.content_item.title = this.data.title : this.data.caption && (this._el.content_item.title = TL.Util.unhtmlify(this.data.caption)),
			this._el.content_item.addEventListener("load", function (e) {
				t.onMediaLoaded()
		...
		createMedia: function () {
			...
			TL.ajax({
				...
				error: function (e, i, n) {
					if (tc = new TL.TimelineConfig, "parsererror" == i)
						var n = new TL.Error("invalid_url_err");
					else
						var n = new TL.Error("unknown_read_err", i);
		...
		_getMeta: function () {
			...
			TL.getJSON(t, function (t) {
				e.data.credit_alternate = "<a href='" + t.author_url + "' target='_blank'>" + t.author_name + "</a>",
			...
			function i(t) {
				function i(e, i) {
					if ("z" == e.slice(-1))
						...
						i.zoom = 14, i.maptype = "satellite";
					else if ("t" == e.slice(-1)) {
						if (n = !0, "place" == mapmode)
							var s = t.match(h.place)[3] + "," + t.match(h.place)[4];
						else {
							var s = i.center;
							delete i.center
						}
				...
				function s(t, s) {
					...
					o.key = e,
					1 == n && (t = "streetview"),
					r + "/embed/v1/" + t + TL.Util.getParamString(o)
				}
				return mapmode = "view",
				t.match(h.place) ? mapmode = "place" : t.match(h.directions) ? mapmode = "directions" : t.match(h.search) && (mapmode = "search"),
				s(mapmode, t.match(h[mapmode]))
			}
			var n = !1,
			a = {
				view: ["center"],
		...
		_loadMedia: function () {
			...
			this._el.content_item = TL.Dom.create("div", "tl-media-item tl-media-iframe", this._el.content);
			var e = "";
			e = TL.Browser.ie || TL.Browser.edge || t.match(/dl.dropboxusercontent.com/) ? "<iframe class='doc' frameborder='0' width='100%' height='100%' src='//docs.google.com/viewer?url=" + t + "&amp;embedded=true'></iframe>" : "<iframe class='doc' frameborder='0' width='100%' height='100%' src='" + t + "'></iframe>",
...
TL.Media.SoundCloud = TL.Media.extend({
		...
		_updateMediaDisplay: function (t) {
			...
			i = 0,
			n = 0;
			e = TL.Browser.mobile ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30,
			this._el.content_item.style.maxHeight = "none",
			trace(e),
			trace(this.options.width),
			e > this.options.width ? (trace("height is greater"), i = this.options.width + 80 + "px", n = this.options.width + "px") : (trace("width is greater"), trace(this.options.width), i = e + "px", n = e - 80 + "px"),
		...
		_loadMedia: function () {
			...
			this.media_id = this.data.url,
			t = "<iframe frameborder='0' width='100%' height='100%' src='" + this.media_id + "/embed'></iframe>",
		...
		_initLayout: function () {
			...
			if ("" != this.data.text) {
				var e = "";
				e += TL.Util.htmlify(1 == this.options.autolink ? TL.Util.linkify(this.data.text) : this.data.text),
		...
		_loadMedia: function () {
			...
			TL.ajax({
				...
				error: function (t, i) {
					var n = "";
					n += e._("twitter_load_err") + "<br/>" + e.media_id + "<br/>" + i,
		...
		createMedia: function (t) {
			...
			a = t.html.split("</p>&mdash;")[1].split('<a href="')[1],
			s = a.split('">')[0],
			o = a.split('">')[1].split("</a>")[0],
			i = i.replace(/<a href/gi, '<a target="_blank" href'),
			i.includes("pic.twitter.com") ? (TL.Load.js("https://platform.twitter.com/widgets.js", function () {
...
TL.Media.TwitterEmbed = TL.Media.extend({
		...
		createMedia: function (t) {
			...
			o = a.split('">')[1].split("</a>")[0],
			i = i.replace(/<a href/gi, '<a target="_blank" href'),
			i.includes("pic.twitter.com") ? (twttr.ready(function (t) {
		...
		_loadMedia: function () {
			...
			this.options.api_key_embedly ? (api_url = "https://api.embed.ly/1/extract?key=" + this.options.api_key_embedly + "&url=" + this.media_id + "&callback=?", TL.getJSON(api_url, function (e) {
					t.createMedia(e)
		...
		createCardContent: function () {
			!function (t, e) {
				...
				if (!e.getElementById(i)) {
					...
					a.id = i,
					a.async = 1,
					a.src = ("https:" === document.location.protocol ? "https" : "http") + "://cdn.embedly.com/widgets/platform.js";
		...
		createMedia: function (t) {
			...
			t.images && t.images[0] && (trace(t.images[0].url), e += "<img src='" + t.images[0].url + "' />"),
		...
		_loadMedia: function () {
			...
			t = "https://" + e + ".wikipedia.org/w/api.php?action=query&prop=extracts|pageimages&redirects=&titles=" + this.media_id + "&exintro=1&format=json&callback=?",
			TL.ajax({
				type: "GET",
				url: t,
				dataType: "json",
				...
				error: function (t, e) {
					var n = "";
					n += i._("wikipedia_load_err") + "<br/>" + i.media_id + "<br/>" + e,
					i.loadErrorDisplay(n)
				}
			})
		},
		createMedia: function (t) {
			...
			if (t.query) {
				...
				e.entry = TL.Util.getObjectAttributeByIndex(t.query.pages, 0),
		...
		_loadMedia: function () {
			...
			this._el.content_item.id = TL.Util.unique_ID(7),
			t = TL.Util.getUrlVars(this.data.url),
			this.media_id = {},
			this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : trace("YOUTUBE IN URL BUT NOT A VALID VIDEO"),
			this.media_id.start = parseInt(t.start),
			isNaN(this.media_id.start) && (this.media_id.start = TL.Util.parseYouTubeTime(t.t)),
			this.media_id.end = parseInt(t.end),
			this.media_id.hd = Boolean("undefined" != typeof t.hd),
		...
		createMedia: function () {
			...
			"undefined" != typeof YT && "undefined" != typeof YT.Player ? this.player = new YT.Player(this._el.content_item.id, {
					playerVars: {
						enablejsapi: 1,
						color: "white",
						autohide: 1,
		...
		createMedia: function () {
			...
			this.data.link ? (this._el.content_link = TL.Dom.create("a", "", this._el.content), this._el.content_link.href = this.data.link, this._el.content_link.target = "_blank", this._el.content_item = TL.Dom.create("audio", e, this._el.content_link)) : this._el.content_item = TL.Dom.create("audio", e, this._el.content),
		...
		createMedia: function () {
			...
			this.data.link ? (this._el.content_link = TL.Dom.create("a", "", this._el.content), this._el.content_link.href = this.data.link, this._el.content_link.target = "_blank", this._el.content_item = TL.Dom.create("video", e, this._el.content_link)) : this._el.content_item = TL.Dom.create("video", e, this._el.content),
			this._el.content_item.controls = !0,
			this._el.source_item = TL.Dom.create("source", "", this._el.content_item),
			this._el.content_item.addEventListener("load", function (e) {
				t.onMediaLoaded()
		...
		getFormattedDate: function () {
			if (TL.Util.trim(this.data.display_date).length > 0)
				return this.data.display_date;
			var t = "";
			return this.has.title || (this.data.end_date && (t = " &mdash; " + this.data.end_date.getDisplayDate(this.getLanguage())), this.data.start_date && (t = this.data.start_date.getDisplayDate(this.getLanguage()) + t)),
			t
		},
		_initLayout: function () {
			...
			this.has.media && (this.data.media.mediatype = TL.MediaType(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this.options.autolink = this.data.autolink, this._media = new this.data.media.mediatype.cls(this.data.media, this.options)),
			(this.has.text || this.has.headline) && (this._text = new TL.Media.Text(this.data.text, {
		...
		_updateDisplay: function (t, e, i) {
			...
			TL.Browser.mobile && this.options.width <= this.options.skinny_size ? (a = 0, s = 0, n = this.options.width) : "landscape" == i || this.options.width <= this.options.skinny_size && (a = 50, s = 50, n = this.options.width - a - s),
			this._el.content.style.paddingLeft = a + "px",
			this._el.content.style.paddingRight = s + "px",
			this._el.content.style.width = n + "px",
			e ? this.options.height = e : this.options.height = this._el.container.offsetHeight,
			this._media && (!this.has.text && this.has.headline ? this._media.updateDisplay(n, this.options.height - this._text.headlineHeight(), i) : this.has.text || this.has.headline ? this.options.width <= this.options.skinny_size ? this._media.updateDisplay(n, this.options.height, i) : this._media.updateDisplay(n / 2, this.options.height, i) : this._media.updateDisplay(n, this.options.height, i)),
		...
		initialize: function (t, e, i, n) {
			...
			"object" == typeof t ? (this._el.container = t, this.options.id = TL.Util.unique_ID(6, "tl")) : (this.options.id = t, this._el.container = TL.Dom.get(t)),
		...
		_findSlideIndex: function (t) {
			var e = t;
			return ("string" == typeof t || t instanceof String) && (e = TL.Util.findArrayNumberByUniqueID(t, this._slides, "unique_id")),
			e
		},
		updateDisplay: function (t, e, i, n) {
			this._updateDisplay(t, e, i, n)
		...
		changeBackground: function (t) {
			...
			t.color_value && "" != t.color_value ? (i = TL.Util.hexToRgb(t.color_value), i || (trace("Invalid color value " + t.color_value), i = this.options.default_bg_color)) : (i = this.options.default_bg_color, t.color_value = "rgb(" + i.r + " , " + i.g + ", " + i.b + ")"),
			e = i.r + "," + i.g + "," + i.b,
			...
			i.r < 255 || i.g < 255 || i.b < 255 || t.image ? (this._nav.next.setColor(!0), this._nav.previous.setColor(!0)) : (this._nav.next.setColor(!1), this._nav.previous.setColor(!1))
		},
		_updateDisplay: function (t, e, i, n) {
			var a,
			s;
			s = "undefined" == typeof n ? this.options.layout : n,
		...
		_initLayout: function () {
			...
			TL.Browser.touch && (this._swipable = new TL.Swipable(this._el.slider_container_mask, this._el.slider_container, {
						enable: {
							x: !0,
							y: !1
						},
		...
		_fireMouseEvent: function (t) {
			if (this._loaded) {
				...
				this.hasEventListeners(e) && ("contextmenu" === e && TL.DomEvent.preventDefault(t), this.fire(e, {
						latlng: "something",
		...
		_getTimeScale: function () {
			...
			return 0 == t && (trace("marker_height_min option must not be zero."), t = 30),
		...
		setZoomFactor: function (t) {
			...
			0 == t && (console.warn("Zoom factor must be greater than zero. Using 0.1"), t = .1),
			this.options.scale_factor = t,
		...
		_positionGroups: function () {
			if (this.options.has_groups)
				for (var t = this.options.height - this._el.timeaxis_background.offsetHeight, e = Math.floor(t / this.timescale.getNumberOfRows() - this.options.marker_padding), i = (this.timescale.getGroupLabels(), 0), n = 0; i < this._groups.length; i++) {
					...
					s = !1;
					a > t - this.options.marker_padding && (s = !0),
					this._groups[i].setRowPosition(a, this._calculated_row_height + this.options.marker_padding / 2),
					this._groups[i].setAlternateRowColor(TL.Util.isEven(i), s),
		...
		_findMarkerIndex: function (t) {
			var e = -1;
			return ("string" == typeof t || t instanceof String) && (e = TL.Util.findArrayNumberByUniqueID(t, this._markers, "unique_id", e)),
			e
		},
		...
		_createEra: function (t, e) {
			...
			this._addEra(i),
			e < 0 ? this._eras.push(i) : this._eras.splice(e, 0, i)
		},
		_addEra: function (t) {
			t.addTo(this._el.marker_item_container),
			t.on("added", this._onEraAdded, this)
		},
		_removeEra: function (t) {
			t.removeFrom(this._el.marker_item_container)
		},
		_destroyEra: function (t) {
			this._removeEra(this._eras[t]),
			this._eras.splice(t, 1)
		},
		...
		_onMouseScroll: function (t) {
			...
			"undefined" != typeof t.wheelDeltaX && (e = t.wheelDeltaY / 6, e = Math.abs(t.wheelDeltaX) > Math.abs(t.wheelDeltaY) ? t.wheelDeltaX / 6 : 0),
			e && (t.preventDefault && t.preventDefault(), t.returnValue = !1),
			i = parseInt(this._el.slider.style.left.replace("px", "")) + e,
			i > n.left ? i = n.left : i < n.right && (i = n.right),
		...
		_updateDrawTimeline: function (t) {
			...
			if (t) {
				...
				e = !0;
			return e ? (this.timescale = this._getTimeScale(), this.timeaxis.positionTicks(this.timescale, this.options.optimal_tick_width), this._positionMarkers(), this._assignRowsToMarkers(), this._positionGroups(), this.has_eras && this._positionEras(), this._updateDisplay()) : this._drawTimeline(!0),
			e
		},
		_initLayout: function () {
		...
		setHeight: function (t) {
			...
			t <= 30 ? this._el.content.className = "tl-timemarker-content tl-timemarker-content-small" : this._el.content.className = "tl-timemarker-content",
			t <= 56 ? TL.DomUtil.addClass(this._el.content_container, "tl-timemarker-content-container-small") : TL.DomUtil.removeClass(this._el.content_container, "tl-timemarker-content-container-small"),
		...
		_initLayout: function () {
			...
			this.data.text.headline && "" != this.data.text.headline ? this._text.innerHTML = TL.Util.unlinkify(this.data.text.headline) : this.data.text.text && "" != this.data.text.text ? this._text.innerHTML = TL.Util.unlinkify(this.data.text.text) : this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = TL.Util.unlinkify(this.data.media.caption)),
			this.onLoaded()
		},
		_initEvents: function () {
		...
		_initLayout: function () {
			...
			this.data.end_date && (this.has_end_date = !0, this._el.container.className = "tl-timeera tl-timeera-with-end"),
			...
			this._text = TL.Dom.create("h2", "tl-headline", this._el.text),
			this.data.text.headline && "" != this.data.text.headline && (this._text.innerHTML = TL.Util.unlinkify(this.data.text.headline)),
			this.onLoaded()
		},
		_initEvents: function () {},
		_updateDisplay: function (t, e, i) {
			...
			if ("human" == t.scale) {
				...
				for (var i = TL.Date.SCALES.length - 1; i >= 0; i--)
					if (e.hasOwnProperty(TL.Date.SCALES[i][0])) {
						...
						return TL.Date.SCALES[i + 1] && (a = TL.Date.SCALES[i + 1]),
						a[1]
					}
				return 31536e6
			}
		...
		_computeRowInfo: function (t, e) {
			for (var i = [], n = 0, a = 0; a < t.length; a++) {
				...
				if ("undefined" == typeof s.row)
					if (null === e)
						s.row = i.length, i.push(s);
					else if (e > 0)
						s.row = i.length, i.push(s), e--;
					else {
		...
		positionTicks: function (t, e, i) {
			i ? (this._el.major.className = "tl-timeaxis-major", this._el.minor.className = "tl-timeaxis-minor") : (this._el.major.className = "tl-timeaxis-major tl-timeaxis-animate", this._el.minor.className = "tl-timeaxis-minor tl-timeaxis-animate"),
		...
		_positionTickArray: function (t, e, i) {
			if (t[1] && t[0]) {
				...
				for (var s = 1, o = 0; o < t.length; o++) {
					...
					a > 1 ? s >= a ? (s = 1, r.tick_text.style.opacity = 1, r.tick.className = "tl-timeaxis-tick") : (s++, r.tick_text.style.opacity = 0, r.tick.className = "tl-timeaxis-tick tl-timeaxis-tick-hidden") : (r.tick_text.style.opacity = 1, r.tick.className = "tl-timeaxis-tick")
				}
			}
		},
		_initLayout: function () {
		...
		_getTicks: function (t, e) {
			for (var i = t._scaled_padding * e.factor, n = t._earliest - i, a = t._latest + i, s = [], o = n; o < a; o += e.factor)
	...
	i("human", TL.Date.SCALES),
	i("cosmological", TL.BigDate.SCALES),
	t.HELPERS = e,
	t.getBestHelper = function (t, i) {
		"number" != typeof i && (i = 100);
		var n = t.getScale(),
		a = e[n];
		if (!a)
			throw new TL.Error("axis_helper_scale_err", n);
...
(TL.AxisHelper), TL.Timeline = TL.Class.extend({
		...
		initialize: function (t, e, i) {
			...
			this.options.is_full_embed && TL.DomUtil.addClass(this._el.container, "tl-timeline-full-embed"),
		...
		_translateError: function (t) {
			return t.hasOwnProperty("stack") && trace(t.stack),
		...
		_calculateTimeNavHeight: function (t, e) {
			var i = 0;
			return t ? i = t : (this.options.timenav_height_percentage || e) && (i = e ? Math.round(this.options.height / 100 * e) : Math.round(this.options.height / 100 * this.options.timenav_height_percentage)),
		...
		_updateDisplay: function (t, e, i) {
			...
			TL.Browser.mobile ? (a += " tl-mobile", this.options.timenav_height = this._calculateTimeNavHeight(t, this.options.timenav_mobile_height_percentage)) : this.options.timenav_height = this._calculateTimeNavHeight(t),
			a += "portrait" == this.options.layout ? " tl-layout-portrait" : " tl-layout-landscape",
			...
			e ? (this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px", this.animator_storyslider && this.animator_storyslider.stop(), this.animator_storyslider = TL.Animate(this._el.storyslider, {
		...
		_updateHashBookmark: function (t) {
			...
			"file:" != window.location.protocol && window.history.replaceState(null, "Browsing TimelineJS", e),
		...
		_initData: function (t) {
			...
			if ("string" == typeof t) {
				...
				TL.TimelineConfig == t.constructor ? this.setConfig(t) : this.setConfig(new TL.TimelineConfig(t))
		},
		setConfig: function (t) {
			if (this.config = t, this.config.validate(), this._validateOptions(), this.config.isValid())
				try {
					this._onDataLoaded()
				} catch (t) {
		...
		_validateOptions: function () {
			for (var t = ["timenav_height", "timenav_height_min", "marker_height_min", "marker_width_min", "marker_padding", "start_at_slide", "slide_padding_lr"], e = 0; e < t.length; e++) {
				...
				n = this.options[i];
				valid = !0,
				"number" == typeof n ? valid = n == parseInt(n) : "string" == typeof n && (valid = n.match(/^\s*(\-?\d+)?\s*$/)),
				valid || this.config.logError({
		...
		_initLayout: function () {
			...
			"top" == this.options.timenav_position ? (this._el.timenav = TL.Dom.create("div", "tl-timenav", this._el.container), this._el.storyslider = TL.Dom.create("div", "tl-storyslider", this._el.container)) : (this._el.storyslider = TL.Dom.create("div", "tl-storyslider", this._el.container), this._el.timenav = TL.Dom.create("div", "tl-timenav", this._el.container)),
